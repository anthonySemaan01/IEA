...
class Kfold_upper_lower(AbstractFeatureExtractor):
    ...
    def kfold(self, path):
        k = 4
        training_samples_size = 2288
        start_idx = 0
        end_idx = int(training_samples_size/k)

        # path of ./training_set_digit_letter.csv
        VECTOR_UPPER_LOWER_PATH = FileStructure.VECTOR_UPPER_LOWER_PATH
        
        with open(VECTOR_UPPER_LOWER_PATH, newline='') as csvfile:
