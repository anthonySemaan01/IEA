...
class ClassOneModelThreeClassifier:
    @staticmethod
    def classify_class_one_model_three(x_test) -> str:
        try:
            # TODO
            # find k
            ...
            df = pd.read_csv(str(FileStructure.VECTOR_CLASSE1_MODEL3.value), index_col=0)
