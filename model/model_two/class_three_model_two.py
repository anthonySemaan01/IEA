...
class ClassThreeModelTwoClassifier:
    @staticmethod
    def classify_class_three_model_two(x_test) -> str:
        try:
            # TODO
            # find k
            ...
            df = pd.read_csv(str(FileStructure.VECTOR_CLASSE3_MODEL2.value), index_col=0)
